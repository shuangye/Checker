...
for(var nToExport = 0; nToExport < esStrsToExport.length; nToExport++)
	eval(esStrsToExport[nToExport] + " = " + app.getString("EScript", esStrsToExport[nToExport]).toSource());
...
color.brGreen = new Array("RGB", 0, 255, 0);
...
color.purple = new Array("RGB", 0.7, 0.6, 1);
color.ltcyan = new Array("RGB", 0.7, 1, 1);
//added by Esther Massimini 06/18/2009
//define a light color.purple
//define a light color.ltcyan
...
function AFSpecial_KeystrokeEx(mask)
{
	...
	var cAlert = IDS_INVALID_VALUE + ' = "' + mask + '"';

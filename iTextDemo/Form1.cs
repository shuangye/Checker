            ...
            else
            {
                ...
                foreach (string s in strFile)
                {
                    ...
                    if (strFiletype.Contains("PDF") || strFiletype.Contains("pdf"))
                    {
                        ...
                        #endregion Read FArea

                        #region Get Author/Moderator info
                        for (int i = 1; i < 39; i++)
                        {
                        ...
                        #endregion Get Author/Moderator info
                                    ...
                                    if (annotarray != null)
                                    {
                                        ...
                                        foreach (PdfIndirectReference annot in annotarray.ArrayList)
                                        {
                                            ...
                                            if (annotStaus == null && (annotSubType.Equals(PdfName.TEXT) || annotSubType.Equals(Highlight)) && prefs == null)
                                            {
                                                ...
                                                strannots = pdfannots.ToString();  // {Should be TC 3. Note: this fails checklist 45.} (the content of moderator's comment)
